A.Penjelasan tentang materi minggu kemaren tentang OOP ,perbedaan OOP, prinsip dasar OOP , contoh dalan lainnya.
B.Mengetahui tentang CLASS, ATRIBUT,dan juga OBJEK dalam sebuah program mengetahui fungsi contoh dan code codenya.
