...
CF = PBOB("M.Irsyadul fikri", "Laki-Laki")
...
mahasiswa1 = mahasiswa("M.Irsyadul fikri", "Laki-Laki", "PBO Kelas B")
mahasiswa2 = mahasiswa("Hestifani Lesya", "Perempuan", "PBO Kelas A")
